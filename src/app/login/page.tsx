  ...
  const navItems = [
    {
      ...
      textColor: "#fff",
      links: [
        { label: "Klinik", ariaLabel: "Klinik Hakkında" },
        { label: "Ekibimiz", ariaLabel: "Ekibimiz" },
      ],
    },
    {
      label: "Hizmetler",
      ...
      textColor: "#fff",
      links: [
        { label: "Fizyoterapi", ariaLabel: "Fizyoterapi Hizmetleri" },
        { label: "Rehabilitasyon", ariaLabel: "Rehabilitasyon" },
      ],
    },
    {
      label: "İletişim",
      ...
      textColor: "#fff",
      links: [
        { label: "Telefon", ariaLabel: "Telefon" },
        { label: "Instagram", ariaLabel: "Instagram" },
        { label: "Konum", ariaLabel: "Konum" },
      ],
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <section className="relative h-screen overflow-hidden bg-[#0a1128]">
        ...
        <div ref={scrollContainerRef} className="h-full overflow-y-auto snap-y snap-mandatory" style={{ scrollBehavior: 'auto' }}>
          <div className="relative h-screen snap-start snap-always flex flex-col px-6 text-center overflow-hidden will-change-transform">
            ...
            <div className="absolute inset-0 z-10 flex flex-col items-center justify-center pointer-events-none">
              <h1 className="text-2xl md:text-3xl tracking-wide drop-shadow-lg text-center leading-relaxed">
                <span className="font-thin"><ShinyText text="MY Fizio" speed={2} color="#b5b5b5" shineColor="#ffffff" spread={120} direction="left" /></span>
                <br />
          ...
          <div className="h-screen snap-start snap-always flex items-center justify-center px-4 py-10 will-change-transform">
